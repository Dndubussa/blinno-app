...
class ApiClient {
  ...
  // Auth
  async register(data: { email: string; password: string; displayName: string; role?: string; firstName?: string; middleName?: string; lastName?: string; phoneNumber?: string; country?: string }) {

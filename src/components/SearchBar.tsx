    ...
    <div className="w-full max-w-2xl mx-auto relative" ref={searchRef}>
      <div className="relative">
        ...
        <Input
          ...
          className="pl-10 pr-4 py-6 text-lg bg-background/95 backdrop-blur"
        />
      </div>

      {isOpen && results.length > 0 && (
        <Card className="absolute top-full mt-2 w-full z-50 max-h-96 overflow-y-auto animate-fade-in">
          <div className="p-2">
